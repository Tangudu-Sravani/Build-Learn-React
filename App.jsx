...
/**
 * ways of using / accepting data and using it
 * - have to declare in function as a parameter props
 *    - using it with curly brackets props.passedKey - ex:- {props.cusinies}
 *    - destructuring using const with keyname - ex:-   const {resName} = props usecase - {resName}
 * - direct destructring in paramter place {resName,cusines}
 */
  ...
  return (
    <div className="body">
      ...
      <div className="restaurant-container">\
        {/* repetative same  cards with same data */}
        {/* <RestaurantCard />
        <RestaurantCard /> */}
        {/* want tocustom data in cards  */}
        <RestaurantCard resName = "Meghana Foods" cusinies="Biryani,North Indian"/>
        <RestaurantCard resName = "Mezza 9" cusinies=" Chinese , Italian"/>
