  ...
  return (
    <div className="res-card" style={styleCard}>
      <img
        className="res-logo"
        src={
          'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_200,h_220/' +
          cloudinaryImageId
        }
      />
  ...
  return (
    <div className="body">
      ...
      <div className="restaurant-container">
        ...
        {/* these arguments are been wraped in a object and passed as props */}
                {/* <RestaurantCard resData = {resList[0]} />
                <RestaurantCard resData = {resList[1]} />
                <RestaurantCard resData = {resList[2]} />
                <RestaurantCard resData = {resList[3]} /> */}
             
                {/* we can use for loop also but instead of forr loop a best practice is used to map  filter reduce */}
                {resList.map(restaurant =>(
                     <RestaurantCard key={restaurant.data.id} resData={restaurant}/>
                  ))}
                  {/* a function which is returning a piece of JSX  */}
